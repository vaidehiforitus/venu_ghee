...
class _ProductListTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (raw.startsWith('data:image')) {
      try { imgBytes = base64Decode(raw.split(',').last); } catch (_) {}
    }
...
// // lib/features/branch_admin/presentation/screen/branch_sell_screen.dart
// import 'package:get/get.dart';
// import 'package:venu_ghee/core/utils/exports/common_exports.dart';
// import 'package:venu_ghee/core/utils/widgets/responsive_helper/responsive_helper.dart';
// import 'package:venu_ghee/features/branch_admin/presentation/controller/branch_sell_controller.dart';
...
//     if (w < 600) {
//       return _MobileSellLayout(controller: controller);
//     }
//
//     // Tablet & Web → BranchAdaptiveScaffold (sidebar + topbar)
//     return BranchAdaptiveScaffold(
//       title: 'Point Of Sell',
//       mobileBody: _MobileSellLayout(controller: controller),
//       tabletBody: _DesktopSellBody(controller: controller),
...
// // ─────────────────────────────────────────────────────────────────────────────
// //  MOBILE LAYOUT
// //  Left: product list  |  cart icon opens bottom sheet
// // ─────────────────────────────────────────────────────────────────────────────
// class _MobileSellLayout extends StatelessWidget {
//   final SellController controller;
//   const _MobileSellLayout({required this.controller});
...
//
// // ─────────────────────────────────────────────────────────────────────────────
// //  DESKTOP BODY  (Tablet + Web)
// //  Left: product list  |  Right: checkout panel
// // ─────────────────────────────────────────────────────────────────────────────
// class _DesktopSellBody extends StatelessWidget {
//   final SellController controller;
//   const _DesktopSellBody({required this.controller});
...
//   Widget build(BuildContext context) {
//     final w = MediaQuery.of(context).size.width;
//     // web → wider checkout panel
//     final checkoutFlex = w >= 1024 ? 3 : 4;
//     final productFlex = w >= 1024 ? 5 : 5;
//
//     return Padding(
//       padding: const EdgeInsets.all(16),
//       child: Row(
...
//                 width: isMobile ? 56.w : 54,
//                 fit: BoxFit.cover,
//                 errorBuilder: (_, __, ___) => _imgPlaceholder(isMobile),
//               )
//                   : Image.asset(
//                 product.image.startsWith('data:') ? ImageConstants.productIcon : product.image,
//                 height: isMobile ? 56.h : 54,
//                 width: isMobile ? 56.w : 54,
//                 fit: BoxFit.cover,
//                 errorBuilder: (_, __, ___) => _imgPlaceholder(isMobile),
...
//   }
//
//   Widget _imgPlaceholder(bool isMobile) {
//     return Container(
//       height: isMobile ? 56.h : 54,
//       width: isMobile ? 56.w : 54,
//       color: ColorConstants.darkWhiteColor,
...
//           icon,
//           size: isMobile ? 13.sp : 13,
//           color: icon == Icons.add ? Colors.white : ColorConstants.textColor,
//         ),
//       ),
//     );
//   }
...
// // ─────────────────────────────────────────────────────────────────────────────
// //  CHECKOUT PANEL
// //  Used both as a bottom sheet (mobile) and a fixed right panel (desktop)
// // ─────────────────────────────────────────────────────────────────────────────
// class _CheckoutPanel extends StatelessWidget {
//   final SellController controller;
//   final bool isMobile;
...
//     showDialog(
//       context: context,
//       builder: (_) => _CustomerDialog(controller: controller),
//     );
//   }
// }
//
...
//           text: value,
//           fontSize: isMobile ? 13.sp : adaptiveFont(context, 12),
//           color: isBold ? ColorConstants.textColor : ColorConstants.lightTextColor,
//           fontWeight: isBold ? FontWeight.w700 : FontWeight.w500,
//         ),
//       ],
//     );
...
//
// // ─────────────────────────────────────────────────────────────────────────────
// //  CUSTOMER DIALOG  (screenshot image 2 – right panel)
// // ─────────────────────────────────────────────────────────────────────────────
// class _CustomerDialog extends StatelessWidget {
//   final SellController controller;
//
//   _CustomerDialog({required this.controller});
//
